...
export function JobstreetIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
...
export function ProviderIcon({
  ...
  if (p === "jobstreet") {
    return <JobstreetIcon className={className} />;
  }
